...
`r round(modelSummary$r.squared*100, 2) ` percent of the variation in sales can be explained by the change in gallons sold on a given day.

**The standard error:** `r round(modelSummary$coefficients[2,2], 2)`
...
**The new equations is:** $Sales = `r round(litersLm$coefficients[1],2)` +
...
Our sales for the day were `r round(diffDat, 2)` than we expected.
