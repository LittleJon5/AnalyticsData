...
I they can show a negitive correlation between crime rates and housing prices they'd be able to justify more police to potentially increase property values

##### Part B

The equation wouldn't be causal. "Correlation isn't Causation". A good equation indicates that crime rate can be used to predict housing prices but doesn't cause them. The property value of a shanty in the middle of a desert with a crime rate of zero doesn't mean that the property is valuable. 

#### Method
##### Part C

The community leader wouldn't want to use crime as the explanitory varible because they want to use crime to explain the housing prices. Their end goal is to try and incease spending on police. To using property value to explain crime would be more likely to pull funding to help citizens build nicer homes or race property values.
...
*Intercept:* `r phillyTran`sLMSummary$coefficients[1,1]`
